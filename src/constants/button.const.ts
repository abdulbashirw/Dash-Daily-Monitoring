export const buttonSX = {
  base: {
    ...
    fontWeight: 'bold',
    '& .MuiCircularProgress-root': { color: 'theme.base.content', width: `24px!important`, height: `24px!important` },
  },
  baseMedium: {
    backgroundColor: 'theme.base.medium',
    color: 'theme.base.content',
    fontWeight: 'bold',
    '& .MuiCircularProgress-root': { color: 'theme.base.content', width: `24px!important`, height: `24px!important` },
  },
  ...
  accent: {
    ...
    fontWeight: 'bold',
    '& .MuiCircularProgress-root': { color: 'theme.accent.content', width: `24px!important`, height: `24px!important` },
  },
  success: {
